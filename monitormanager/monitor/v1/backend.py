...
class DBBackend(object):
    ...
    def _update_group_instance(self, user_id, group_id, group_dict, session):
        ...
        if instances_string:
            ...
            if instance_ids:
                ...
                old_instances = session.query(models.Instance) \
                    ...
                    .filter(models.Instance.group_id == group_id).all()
    ...
    def add_group(self, user_id, group_dict):
        ...
        self._update_group_instance(user_id, group_id, group_dict, ss)
        ss.add(group)
        ss.commit()
